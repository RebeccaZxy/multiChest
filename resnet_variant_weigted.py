...
inbalance_weight = torch.Tensor([1/8236,1/1989,1/9561,1/14240,1/4175,1/4537,1/962,1/3825,1/3317,1/1637,1/1819,1/1237,1/2431,1/162]).to(computing_device)
inbalance_weight/torch.norm(inbalance_weight)
criterion = nn.MultiLabelSoftMarginLoss(weight=inbalance_weight)
...
model_path = '{}/models/resnet_variant/weighted/{}/'.format(os.getcwd(), time.strftime("%Y%m%d-%H%M%S"))
...
loss_path = '{}/losses/resnet_variant/weighted/{}/'.format(os.getcwd(), time.strftime("%Y%m%d-%H%M%S"))
