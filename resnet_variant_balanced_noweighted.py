...
model_path = '{}/models/resnet_variant/balanced/{}/'.format(os.getcwd(), time.strftime("%Y%m%d-%H%M%S"))
...
loss_path = '{}/losses/resnet_variant/balanced/{}/'.format(os.getcwd(), time.strftime("%Y%m%d-%H%M%S"))
